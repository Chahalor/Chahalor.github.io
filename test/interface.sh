...
while true; do
	...
	case $choix in
		1)
			curl -O https://raw.githubusercontent.com/Chahalor/parrot-invasion/refs/heads/main/parrot_invasion.sh
		...
		2)
			curl -O https://raw.githubusercontent.com/Chahalor/parrot-invasion/refs/heads/main/parrot_invasion.sh
			curl -O https://raw.githubusercontent.com/Chahalor/parrot-invasion/refs/heads/main/crontab.sh
			chmod -x ./crontab.sh
			chmod -x ./parrot_invasion.sh
